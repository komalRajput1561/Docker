...
exports.config = {                   //This line exports a configuration object for WebDriverIO to use.
    specs: [
        './tests/De_login.js'            //This line specifies the location of the test files to run
      ],
    ...
    capabilities: [                  //This section defines the capabilities of the browser to use for running the tests
        ...
        //    'goog:chromeOptions': {
        //     args: ['--disable-infobars', '--disable-popup-blocking', '--no-default-browser-check', '--start-maximized', '--headless']
        //   },
        //   path: '/path/to/chrome'
    ...
    baseUrl: 'https://47test.dev.decisionengines.ai/',
...
//       services: [['webdriver', {browser: 'chrome'}]],
// mochaOpts: {
//   require: 'pactum-webdriver/mocha'
// },
    mochaOpts: {
